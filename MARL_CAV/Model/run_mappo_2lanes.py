...
def parse_args():
    ...
    default_config_dir = 'configs/configs_ppo_tuned.ini'
...
def train(args):
    ...
    now = "mappo_2lanes"#datetime.utcnow().strftime("%b_%d_%H_%M_%S")
...
def evaluate(args):
    ...
    rewards, _, steps, avg_speeds,crash = mappo.evaluation(env, video_dir, len(seeds), is_train=False)
